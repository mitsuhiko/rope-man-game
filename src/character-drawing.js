...
const CHARACTER_HATS = {
  ...
  'chin-mask': { src: 'assets/hats/chin-mask.png', label: 'chin mask', width: 30, height: 25, up: -7, side: 0 },
  ...
  'grand-mustache-goatee': { src: 'assets/hats/grand-mustache-goatee.png', label: 'grand mustache', width: 53, height: 32, up: -6, side: 0 },
  ...
  helmet: { src: 'assets/hats/helmet.png', label: 'helmet', width: 42, height: 42, up: 14, side: 0 },
