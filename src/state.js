...
const startCreditsOpenEl = document.getElementById('start-credits-open');
const startCreditsMenuEl = document.getElementById('start-credits-menu');
const startCreditsCloseEl = document.getElementById('start-credits-close');
const startHelpOpenEl = document.getElementById('start-help-open');
const startHelpMenuEl = document.getElementById('start-help-menu');
const startHelpCloseEl = document.getElementById('start-help-close');
